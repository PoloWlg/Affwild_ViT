...
CONTEXT_TEMPORAL_DIM = 512
FEATURE_CONTEXT_TEMPORAL_DIM = 512
...
config = {
    ...
    "tcn": {
        ...
        "channels": {
            ...
            'context': [CONTEXT_TEMPORAL_DIM // 2, CONTEXT_TEMPORAL_DIM // 2, CONTEXT_TEMPORAL_DIM // 4, CONTEXT_TEMPORAL_DIM // 4],
            'feature_context': [CONTEXT_TEMPORAL_DIM // 2, CONTEXT_TEMPORAL_DIM // 2, CONTEXT_TEMPORAL_DIM // 4, CONTEXT_TEMPORAL_DIM // 4]
        },
        "kernel_size": 5,
        "dropout": 0.1,
        "attention": 0,
    ...
    "time_delay": 0,
    "metrics": ["f1_score_average", "f1_score", "class_distribution","class_distribution_percent"],
    "save_plot": 0,
