...
class GenericImageExperiment(object):
    def __init__(self, args):
        ...
        self.dataset_path = self.set_dataset_path(args.dataset_path, args.dataset_path2)
    ...
    def set_dataset_path(self, dataset_path, dataset_path2):
        if os.path.exists(dataset_path):
            self.dataset_path = dataset_path
        elif os.path.exists(dataset_path2):
            self.dataset_path = dataset_path2
        else:
